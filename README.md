...
- [ ] Improve the interface specifically when displaying the new shortened URL, then of inputting the valid URL, must be press "Update" and select the "Shorter" button again.
